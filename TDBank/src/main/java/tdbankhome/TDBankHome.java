...
public class TDBankHome extends WebAPI {
    ...
    @FindBy(how = How.XPATH, using = creditCardIconWebElement) public WebElement creditCardIcon;
    @FindBy(how = How.XPATH, using = tdCashCreditCardBtnWebElement) public WebElement tdCashCreditCardBtn;
    @FindBy(how = How.XPATH, using = cashCardImageWebElement) public WebElement cashCardImage;
    @FindBy(how = How.XPATH, using = tdFirstClassCardWebElement) public WebElement tdFirstClassCard;
    @FindBy(how = How.XPATH, using = firstClassImageWebElement) public WebElement firstClassImage;
    @FindBy(how = How.XPATH, using = helpMeChooseBtnWebElement) public WebElement helpMeChooseBtn;
    @FindBy(how = How.XPATH, using = cashBtnWebElement) public WebElement cashBtn;
    @FindBy(how = How.XPATH, using = nextBtnWebElement) public WebElement nextBtn;
    @FindBy(how = How.XPATH, using = helpValidateTextWebElement) public WebElement helpValidateText;
    ...
    @FindBy(xpath = "//a[contains(text(),'Sign')]") WebElement signUpBtn;
    @FindBy(xpath = "//label[@class='card'][contains(text(),'I am the account owner for all accounts.')]") WebElement plsConfirmCheckBtn;
    @FindBy(xpath = "//label[@class='card']") WebElement eSignAcceptCheckBox;
    ...
    @FindBy(xpath = "//*[@id=\"formElement_12\"]") WebElement userAtmNumber;
    ...
    @FindBy(xpath = "//input[@id='formElement_14']") WebElement enterUserName;
    ...
    @FindBy(xpath = "//a[@id='td-desktop-nav-dropdown-link-2']//span[@class='td-icon expand']") WebElement productDropDownIcon;
    @FindBy(xpath = "//li[@class='td-dropdown td-dropdown-active']//ul[@class='td-dropdown-content']//li//a[contains(text(),'Checking')]") WebElement checkingBtn;
    @FindBy(xpath = "//h1[contains(text(),'TD Bank Checking Accounts')]") WebElement checkingBtnTxt;
    @FindBy(xpath = "//button[@class='td-button td-button-secondary td-button-large td-copy-nowrap loginout']") WebElement tdHomePageLogInBtn;
    @FindBy(xpath = "//input[@id='formElement_0']") WebElement userNameField;
    @FindBy(xpath = "//input[@id='formElement_1']") WebElement userPasswordField;
    @FindBy(xpath = "//*[@id=\"loginForm\"]/button") WebElement logInBtn;
    @FindBy(xpath = "/html/body/div[2]/div/div/div/div[1]/div/div[2]") WebElement loginErrorMsg;
    @FindBy(xpath = "//li[@class='find-us']//span[@class='td-icon']") WebElement findUsIcon;
    @FindBy(xpath = "//input[@id='q']") WebElement locatorSearchBox;
    @FindBy(xpath = "//img[@class='Locator-searchIcon']") WebElement locatorSearchIcon;
    @FindBy(xpath = "//div[@class='ResultSummary']") WebElement findUsValidationText;
    @FindBy(xpath = "//*[@id=\"js-yl-USBRANCH40244\"]/article/div[11]/div/div/div/a") WebElement getDirectionBtn;
...
//        alert.accept();
    ...
    public void landingOnLocationsPage() throws InterruptedException {
        clickOnFindUsIcon();
        locatorSearchBox.sendKeys("11432");
        sleepFor(3);
        locatorSearchIcon.submit();
        sleepFor(3);
    }
