...
public class TDBankHome extends WebAPI {
    ...
    WebElement onlineBankingValidateText;

    public void logInIconCheck(){
    ...
    public void validateOnlineBanking(){
       String actualResult="TD Bank Online Banking";
        String expectedResult=onlineBankingValidateText.getText();
        Assert.assertEquals("Text do not match",actualResult,expectedResult);

    }
///////////bdd 2///////bdddddddddddd //2
    ...
    WebElement atmCard;
    @FindBy(how= How.XPATH, using =signUpAccountNumber )
    ...
    public void enterPersonalInformation() throws InterruptedException {
        signUpFirstName.sendKeys("jony");
        signUpLastName.sendKeys("hossain");
        signUpEmailAddress.sendKeys("jonhossn@gmail.com");
        wait(3000);
    }
