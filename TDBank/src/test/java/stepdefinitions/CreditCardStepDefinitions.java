...
import tdbankcreditcard.CreditHome;

public class CreditCardStepDefinitions extends WebAPI {

    static CreditHome creditHome;
    @After // class project
    ...
    @BeforeStep
    public void getInIt() {
        creditHome = PageFactory.initElements(driver, CreditHome.class);
    }
    ...
    public void i_click_on_td_first_class_credit_card_button() {
        creditHome.clickOnTdFirstClassCreditCard();
    }
