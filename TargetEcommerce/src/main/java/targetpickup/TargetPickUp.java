...
import static targetpickup.TargetPickUpWebElements.orderPickUpBtnWebElement;
import static targetpickup.TargetPickUpWebElements.*;

public class TargetPickUp extends WebAPI {
    static TargetHomePage targetHome;
