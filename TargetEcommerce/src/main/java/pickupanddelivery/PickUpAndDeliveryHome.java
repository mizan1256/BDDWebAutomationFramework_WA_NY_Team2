...
import static pickupanddelivery.PickUpAndDeliveryWebElement.*;


public class PickUpAndDeliveryHome extends WebAPI {
    static TargetEcommerceHomePage ecommerceHomePage;
