...
import targetecomhome.TargetEcomHome;

import java.io.IOException;
import java.util.List;

public class TargetEcomSteps extends WebAPI {


    static TargetEcomHome targetHomePage;
    ...
    @BeforeStep
    public void getInIt() {
        targetHomePage = PageFactory.initElements(driver, TargetEcomHome.class);
    }

    @Given("I am on targetEcommerce home page")
    public void i_am_on_target_ecommerce_home_page() throws IOException, IOException {
