...
import static targetecommarcehome.TargetHomePageElement.*;

public class TargetHomePage extends WebAPI {

    @FindBy(how = How.XPATH, using = webElementCart)
    public WebElement cartButton;
    @FindBy(how = How.XPATH, using = webElementSignIn)
    public WebElement signInButton;
    @FindBy(how = How.XPATH, using = createYourTargetAccount)
    public WebElement createTargetAccount;
    @FindBy(xpath = "/html/body/div[9]/div/div/div/div[2]/div/div/form/div[6]/div[2]/button")
    WebElement validateShoppingCartText;

    @FindBy(how = How.XPATH, using = userNameBox)
    public WebElement userName;
    @FindBy(how = How.XPATH, using = userPasswordBox)
    public WebElement userPassword;
    @FindBy(xpath = "//*[@id=\"login\"]")
    WebElement signIn;
//    @FindBy(how = How.XPATH, using = userSignBox) public WebElement userSign;

    @FindBy(how = How.XPATH, using = dropDownSignInButton)
    ...
    @FindBy(how = How.XPATH, using = createAcccountTab)
    public WebElement createAcc;
    @FindBy(how = How.XPATH, using = emailAddressBox)
    public WebElement emailAdd;
    @FindBy(how = How.XPATH, using = useFirstNameBox)
    public WebElement useFirstName;
    @FindBy(how = How.XPATH, using = useLastNameBox)
    public WebElement useLastName;
    @FindBy(how = How.XPATH, using = useMobileNumber)
    public WebElement useMobile;
    @FindBy(how = How.XPATH, using = usePasswordBox)
    public WebElement usePassword;
    @FindBy(how = How.XPATH, using = useSignInCreateAccount)
    public WebElement useCreateAnAccount;
    @FindBy(how = How.XPATH, using = useLogInButton)
    public WebElement useLogIn;
    @FindBy(how = How.XPATH, using = useSignInButton)
    public WebElement useSignIn;
    ...
    @FindBy(how = How.XPATH, using = disposableMaskText)
    public WebElement faceMask;
    @FindBy(how = How.XPATH, using = clothMasks)
    public WebElement clothMask;
    @FindBy(how = How.XPATH, using = clearanceImg)
    public WebElement clearance;
    @FindBy(how = How.XPATH, using = webElementFurnitureClerance)
    public WebElement furnitureClearance;
    @FindBy(how = How.XPATH, using = webElementFilterResultText)
    public WebElement filterText;
    @FindBy(how = How.XPATH, using = weeklyAdTab)
    public WebElement weeklyAd;
    @FindBy(how = How.XPATH, using = showTargetLogo)
    public WebElement showLogo;
    @FindBy(how = How.XPATH, using = landGiftCard)
    public WebElement giftCard;
    @FindBy(how = How.XPATH, using = giftCatdText)
    public WebElement cardText;
    @FindBy(how = How.XPATH, using = checkYourBalance)
    public WebElement checkBalance;
    @FindBy(how = How.XPATH, using = cardBalanceText)
    public WebElement balanceText;
    @FindBy(how = How.XPATH, using = checkEmailButton)
    public WebElement checkEmail;
    @FindBy(how = How.XPATH, using = checkMailButton)
    public WebElement checkMail;
    @FindBy(xpath = "//a[@class='Link-sc-1khjl8b-0 kPdxNk'][contains(text(),'Registry')]")
    public WebElement registryButton;
    @FindBy(xpath = "//button[contains(text(),'create a baby registry')]")
    public WebElement createBabyField;
    @FindBy(xpath = "//div[@class='styles__ContentWrapper-vnn8rt-1 iacQrW']//div[2]//a[1]//img[1]")
    public WebElement appStoreLogo;
    @FindBy(xpath = "//span[contains(text(),'easy for everyone')]")
    public WebElement easyText;
