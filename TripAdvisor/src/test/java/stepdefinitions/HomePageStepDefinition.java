...
// Take a screenshot...
    ...
    @BeforeStep
    public void getInit(){
        tripAdvisorHome= PageFactory.initElements(driver,TripAdvisorHomePage.class);
    }
...
// One Way Trip
    ...
    public void i_click_post_photos_button_and_click_add_photo_btn() throws InterruptedException {
