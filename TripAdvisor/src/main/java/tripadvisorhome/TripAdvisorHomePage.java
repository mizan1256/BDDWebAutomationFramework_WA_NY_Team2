...
import static tripadvisorhome.TripAdvisorWebElement.homeSearchBox;
import static tripadvisorhome.TripAdvisorWebElement.homeSearchButton;
...
//    }
    ...
    public void calenderCheckIn() throws InterruptedException {
        calender.click();
        sleepFor(3);
        selectDateByJS1(driver, calender, dateValue, returnDate);
        Thread.sleep(4000);
    }
