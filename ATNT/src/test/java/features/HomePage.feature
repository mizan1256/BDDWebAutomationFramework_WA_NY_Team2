...
#    And I verify page title as "<pageTitle>"
    Examples:
      ...
      | iphone 11         | \"iphone 11\"         | Results for iphone 11 - AT&T Search         |
      | iphone x          | \"iphone x\"          | Results for iphone x - AT&T Search          |
      | Apple ipad        | \"Apple ipad\"        | Results for Apple ipad - AT&T Search        |
      | iphone 11 Pro Max | \"iphone 11 Pro Max\" | Results for iphone 11 Pro Max - AT&T Search |
      | Samsung s20       | \"Samsung s20\"       | Results for Samsung s20 - AT&T Search       |
